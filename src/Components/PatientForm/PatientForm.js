...
const PatientForm = () => {
  ...
  const validateForm = () => {
    ...
    } else if (!agePattern.test(formData.age.trim()) || parseInt(formData.age, 10) > 120) {
    ...
    } else if (!heightPattern.test(formData.height.trim()) || parseInt(formData.height, 10) > 250) {
    ...
    } else if (!weightPattern.test(formData.weight.trim()) || parseInt(formData.weight, 10) > 500) {
    ...
    <div className={styles['form-box']}>
      ...
      <form onSubmit={handleSubmit}>
        ...
        <Input
          ...
          error={errors.gender}
        />
        <button type="submit" className={styles['form-btn']}>Submit</button>
      </form>
    </div>
  );
};
